...
import ru.lyrian.kotlinmultiplatformsandbox.android.feature.spaceXLaunches.presentation.ui.SpaceXLaunchesScreen
...
fun NavigationRoot() {
    ...
    NavHost(navController = navController, startDestination = NavigationDestinations.LAUNCHES_LIST.route) {
        composable(NavigationDestinations.LAUNCHES_LIST.route) { SpaceXLaunchesScreen(navController) }
